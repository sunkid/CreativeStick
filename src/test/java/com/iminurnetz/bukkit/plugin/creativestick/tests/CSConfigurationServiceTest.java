...
public class CSConfigurationServiceTest extends TestCase {
    public void testVersion() throws FileNotFoundException, IOException, InvalidConfigurationException, URISyntaxException {
		URL topDir = getClass().getResource("/");
        File configFile = new File(new File(topDir.toURI()), "../../src/main/resources/config.yml");
